    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Create New Review</h4>
                    ...
                    <form action="{{ route('admin.reviews.store') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('service_type') is-invalid @enderror" id="service_type" name="service_type">
                                    ...
                                    <option value="EPC" {{ old('service_type') == 'EPC' ? 'selected' : '' }}>EPC Services</option>
                                    <option value="Finance" {{ old('service_type') == 'Finance' ? 'selected' : '' }}>Solar Finance</option>
                                    <option value="O&M" {{ old('service_type') == 'O&M' ? 'selected' : '' }}>Operations & Maintenance</option>
                                    <option value="Rooftop" {{ old('service_type') == 'Rooftop' ? 'selected' : '' }}>Rooftop Solar</option>
                                    <option value="Ground" {{ old('service_type') == 'Ground' ? 'selected' : '' }}>Ground-Mounted Solar</option>
                                </select>
                                @error('service_type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('review_text') is-invalid @enderror" 
                                      id="review_text" name="review_text" rows="4" required>{{ old('review_text') }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select @error('review_source') is-invalid @enderror" id="review_source" name="review_source">
                                    <option value="website" {{ old('review_source') == 'website' ? 'selected' : '' }}>Website</option>
                                    <option value="google" {{ old('review_source') == 'google' ? 'selected' : '' }}>Google</option>
                                    <option value="facebook" {{ old('review_source') == 'facebook' ? 'selected' : '' }}>Facebook</option>
                                    <option value="other" {{ old('review_source') == 'other' ? 'selected' : '' }}>Other</option>
                                </select>
                                @error('review_source')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
