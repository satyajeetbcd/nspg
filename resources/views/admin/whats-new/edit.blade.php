...
@section('title', 'Edit What\'s New Item - NSPG')
@section('page-title', 'Edit What\'s New Item')
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">
                    ...
                    Edit What's New Item
                </h5>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.whats-new.update', $whatsNew) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-md-8">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('title') is-invalid @enderror" 
                                       id="title" name="title" value="{{ old('title', $whatsNew->title) }}" required>
                                @error('title')
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" 
                                          id="description" name="description" rows="5" required>{{ old('description', $whatsNew->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('hindi_description') is-invalid @enderror" 
                                          id="hindi_description" name="hindi_description" rows="5">{{ old('hindi_description', $whatsNew->hindi_description) }}</textarea>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control @error('publish_date') is-invalid @enderror" 
                                       ...
                                       value="{{ old('publish_date', $whatsNew->publish_date->format('Y-m-d')) }}" required>
                                @error('publish_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('sort_order') is-invalid @enderror" 
                                       ...
                                       value="{{ old('sort_order', $whatsNew->sort_order) }}" min="0">
                                @error('sort_order')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="is_active" name="is_active" 
                                           value="1" {{ old('is_active', $whatsNew->is_active) ? 'checked' : '' }}>
