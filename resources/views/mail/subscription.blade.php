            ...
            <td align="center" style="padding:24px;">
                <table role="presentation" width="600" cellspacing="0" cellpadding="0" border="0"
                    ...
                    <tr>
                        <td
                            style="padding:0 24px 8px 24px;font-family:Arial,Helvetica,sans-serif;font-size:16px;line-height:24px;color:#0f172a;">
                            Your workspace <strong>{{isset($workspace_name) ? $workspace_name: "workspace_name"}}</strong> is live. Here are a few quick links to
                            get started:
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td align="center" style="padding:16px 24px 8px 24px;">
                            <a href="{{ isset($dashboard_url) ? $dashboard_url : 'dashboard_url'}}"
                ...
                <table role="presentation" width="600" cellspacing="0" cellpadding="0" border="0"
                    ...
                    <tr>
                        <td
                            ...
                            © {{isset($current_year) ? $current_year : "current_year"}} The Future ERP · <a href="{{ isset($preferences_url) ? $preferences_url : 'preferences_url'}}"
