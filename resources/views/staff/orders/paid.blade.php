    ...
    <div class="container mb-4">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                ...
                <p class="text-muted mb-0">{{ __('Review and accept Paid orders to create customer subscriptions') }}</p>
            </div>
            <div>
        ...
        <div class="card border-0 shadow-sm rounded-4">
            <div class="card-header bg-warning-subtle rounded-top-4 py-3">
                <h5 class="mb-0 fw-bold text-warning">
                    <i class="fas fa-clock me-2"></i>{{ __('Paid Orders') }} ({{ $orders->total() }})
                </h5>
            </div>
