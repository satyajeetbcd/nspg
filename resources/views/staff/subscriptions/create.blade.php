                ...
                <div class="card border-0 shadow-sm rounded-4">
                    <div class="card-header bg-light rounded-top-4 py-3">
                        <h5 class="mb-0 fw-bold text-white">
                            <i class="fas fa-plus-circle me-2"></i>{{ __('Subscription Details') }}
                        </h5>
                    </div>
                    <div class="card-body p-4">
                        <x-form id="subscriptionForm" action="{{ route('staff.subscriptions.store') }}" method="POST" :axios="true">
                            <div class="row g-3">
                                {{-- Customer Selection --}}
                                <div class="col-md-6">
                                ...
                                <div class="col-12 mt-4">
                                    <div class="d-flex gap-2 justify-content-end">
                                        <a href="{{ route('staff.subscriptions.index') }}" class="btn btn-light">
                                            <i class="fas fa-arrow-left me-1"></i>{{ __('Cancel') }}
                                        </a>
                                        <button type="submit" class="btn btn-success">
                                            <i class="fas fa-check-lg me-1"></i>{{ __('Create Subscription') }}
                                        </button>
                                    </div>
                                </div>
                            </div>
